...
public class RestauranteController : ControllerBase
{
    ...
    public async Task<ActionResult<RestauranteReadDto>> CreateRestaurante(RestauranteCreateDto restauranteCreateDto)
    {
        ...
        // Para quando efetuarmos o cadastro de um restaurante, o ItemService receba esse registro para conseguirmos cadastrar novos itens nesse restaurante

        // A primeira solução é enviarmos uma requisição via HTTP (Comunicação Sincrona via HTTP Cliente)

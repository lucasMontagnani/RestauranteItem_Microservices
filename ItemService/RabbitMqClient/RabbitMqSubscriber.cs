...
namespace ItemService.RabbitMqClient
{
    public class RabbitMqSubscriber : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            // O EventArgs é basicamente o que temos de conteúdo bruto dentro desse consumidor que estamos processando.
            ...
            // Precisamos informar que consumimos o conteúdo dessa fila
            // O autoAck indica que foi feito o processamento e envia essa informação, informando que foi consumido.
